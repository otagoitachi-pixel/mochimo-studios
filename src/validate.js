...
const LINK_TYPES = ['social', 'website', 'whatsapp', 'email', 'phone', 'custom', 'product', 'music', 'video', 'booking', 'facebook'];
const EVENT_TYPES = ['view', 'click', 'nfc_tap', 'qr_scan'];
const THEMES = ['mochimo', 'minimal', 'soft', 'lavender', 'blush', 'dark', 'custom', 'photographer'];
